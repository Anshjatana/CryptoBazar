  ...
  return (
    <div className="rounded-div my-6 p-6">
      <div className="flex py-6 items-center px-6">
        <img src={coin.image?.large} alt="/" className="md:w-20 md:h-20 h-12 w-12 mr-8 rounded-full" />
        <div>
      ...
      <div className="flex justify-between flex-col md:flex-row items-center">
        <div className="md:w-[47%] w-[90%]">
          <p className="md:text-3xl text-2xl font-bold">${coin.market_data?.current_price.usd.toLocaleString()}</p>
